      ...
      <div className="App">
        ...
        <div className="content">
          ...
          <Routes>
            ...
            <Route path="/contractor/sign-up" element={<ContractorSignUp />} />
            <Route path="/contractor/sign-in" element={<ContractorSignIn />} />
            ...
            <Route path="/customer/vehicles/edit" element={<EditVehicle />} />
